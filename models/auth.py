...
class User(Base):
    ...
    github_id: Mapped[str] = mapped_column(String(32), nullable=True)
    google_id: Mapped[str] = mapped_column(String(32), nullable=True)
    linkedin_id: Mapped[str] = mapped_column(String(32), nullable=True)
